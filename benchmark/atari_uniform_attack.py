...
def get_args():
    ...
    parser.add_argument('--image_attack', type=str, default='fgm')  # fgsm, cw, pgda
...
def benchmark_adversarial_policy(args=get_args()):
    ...
    if args.save_video:
        log_path = os.path.join(args.logdir, args.task, args.policy, "uniform_attack_eps-" + str(args.eps) +\
                                "_freq-" + str(args.attack_freq) + "_" + args.target_policy)
