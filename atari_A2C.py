...
def get_args():
    ...
    parser.add_argument('--modelname', type=str, default='a2c')
...
def test_a2c(args=get_args()):
    ...
    if not args.test:
        ...
        if args.savedir is not None:
            save_model(actor, model_name=args.modelname, save_path=args.savedir)

    # Let's watch its performance!
    collector = Collector(policy, env)
    result = collector.collect(n_episode=args.eval_num, render=0.)
