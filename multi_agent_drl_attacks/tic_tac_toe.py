...
def get_args():
    ...
    parser.add_argument('--ep_watch', type=int, default=1,
    ...
    parser.add_argument('--freeze_opponent', default=False, action='store_true',
                        help='prevent the opponent agent from learning')
    parser.add_argument('--model_save_path', default=False, action='store_true',
                        help='the path where to sve the agent pth file')
...
def get_agents(args=get_args(),
    ...
    if args.freeze_opponent:
        agent_opponent = FrozenPolicy(agent_opponent)
...
if __name__ == '__main__':
    ...
    def watch(args=get_args(),
        ...
        result = collector.collect(n_episode=args.ep_watch, render=args.render)
